    ...
    def profile_params
      if @profile.initial?
        ...
        params.permit(experiences_attributes: [:exp_type, :name, :description, :start_date,
          :end_date, :city_id, :country_id, :aiesec_experience, :committee_id, :seniority_id])
      elsif @profile.experience_b?
        params.permit(experiences_attributes: [:exp_type, :name, :description, :start_date,
          :end_date, :city_id, :country_id, :organization_name, :aiesec_experience, :committee_id, :seniority_id])
      elsif @profile.experience_c?
        params.permit(experiences_attributes: [:exp_type, :name, :description, :start_date,
          :end_date, :city_id, :country_id, :organization_name, :internship, :committee_id, :seniority_id])
